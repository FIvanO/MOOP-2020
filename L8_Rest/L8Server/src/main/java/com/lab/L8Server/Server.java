...
public class Server {
    private String makeQuery(Operation type, BDEntity entity, ShowType show_type, String query) throws Exception {
        ...
        switch (entity) {
            case Model:
                switch (type) {
                    ...
                    default:
                        return "Wrong operation for Model BDEntity.";
                }
            case Manufacturer:
                switch (type) {
                    case Add:
...
//                        System.out.println("");
                    ...
                    default:
                        return "Wrong operation for Manufacturer BDEntity.";
                }
            case Unknown:
                switch (type) {
                    case Show:
                    ...
                    default:
                        return "Wrong operation for non-selected BDEntity.";
                }
            default:
    ...
    public String processClientMessage(String mes) throws Exception {
        Operation type;
        int index = 0;
        ...
        System.out.println("BDEntity is ");
        BDEntity obj = BDEntity.Unknown;
        ...
        switch (type) {
            ...
            case Delete:
                if (mes.indexOf("Model", index) == index) {
                    ...
                    obj = BDEntity.Manufacturer;
                    index += "Manufacturer".length();
                    System.out.println("Manufacturer");
                }
                ++ index; // space after BDEntity type in client msg
                break;
            case Calculate:
                break;
            case Show:
        ...
        if (obj == BDEntity.Unknown && show_type == ShowType.Unknown && type != Operation.Calculate) {
